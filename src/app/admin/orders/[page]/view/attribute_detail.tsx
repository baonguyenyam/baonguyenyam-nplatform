					...
					<div className="group">
						<div className="flex flex-col">
							...
							{data?.vendor?.length === 0 && (
								<div className="text-xs text-gray-500">No vendor assigned</div>
							)}
						</div>
					</div>
					<div className="group">
				...
				<div className="grid grid-cols-1 gap-4 xl:grid-cols-2 xl:gap-10">
					<div className="group">
						...
						<div className="flex flex-col">
							...
							{data?.user_manager?.length === 0 && (
								<div className="text-xs text-gray-500">No manager assigned</div>
							)}
						</div>
					</div>
					<div className="group">
						...
						<div className="flex flex-col">
							...
							{data?.user_product?.length === 0 && (
								<div className="text-xs text-gray-500">No product assigned</div>
							)}
						</div>
					</div>
					<div className="group">
						...
						<div className="flex flex-col">
							...
							{data?.user_shipping?.length === 0 && (
								<div className="text-xs text-gray-500">
									No shipping assigned
								</div>
							)}
						</div>
					</div>
					<div className="group">
						...
						<div className="flex flex-col">
							...
							{data?.user?.length === 0 && (
								<div className="text-xs text-gray-500">No user assigned</div>
							)}
						</div>
					</div>
				</div>
