...
import { $createParagraphNode, $getNodeByKey, $getSelection, $isRangeSelection, CAN_REDO_COMMAND, CAN_UNDO_COMMAND, FORMAT_ELEMENT_COMMAND, FORMAT_TEXT_COMMAND, REDO_COMMAND, SELECTION_CHANGE_COMMAND, UNDO_COMMAND } from "lexical";
	...
	return (
		<div
			...
			<button
				...
				<span className="text">H1 Heading</span>
			...
			<button
				type="button"
				className="item"
				onClick={formatH3Heading}>
				<span className="icon h3-heading" />
				<span className="text">H3 Heading</span>
